      ...
      <DialogContent className="sm:max-w-md rounded-2xl">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-lg font-semibold">Pengeluaran</DialogTitle>
              <DialogDescription>Catat pengeluaran dari dompet Anda</DialogDescription>
            </div>
          </div>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div className="space-y-2">
            <Label htmlFor="expense-nominal" className="text-sm font-medium text-gray-700">Nominal</Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="expense-dompet" className="text-sm font-medium text-gray-700">Dari Dompet</Label>
            <Select 
          ...
          <div className="space-y-2">
            <Label htmlFor="expense-keterangan" className="text-sm font-medium text-gray-700">Keterangan</Label>
            <Input
          ...
          <Button 
            type="submit" 
            className="w-full h-11 rounded-xl bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white font-medium shadow-lg shadow-red-200 transition-all duration-200" 
            disabled={loading || loadingWallets}
          >
            {loading ? (
